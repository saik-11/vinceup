  ...
  return (
    ...
    >
      ...
      <div className="flex items-center shrink-0 mt-2 sm:mt-0">
        {isUpcoming ? (
          <Button className="w-full gap-2 px-6 text-white rounded-full shadow-sm sm:w-auto bg-[linear-gradient(135deg,#7c3aed,#c026d3)] hover:opacity-90 hover:shadow-[0_8px_20px_-6px_rgba(124,58,237,0.6)] active:scale-95 transition-all duration-200">
          ...
          <Button
            variant="ghost"
            className="justify-between w-full gap-1 px-4 sm:justify-center sm:w-auto text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 hover:bg-violet-50 dark:hover:bg-violet-500/10 group/btn"
          >
            {session.actionLabel}
