  ...
  return (
    <>
      ...
      <div className="h-full w-full flex flex-1 flex-col items-center justify-center gap-4 text-center px-4 py-20">
        ...
        <p className="text-base text-muted-foreground max-w-sm leading-relaxed">The page you&apos;re looking for doesn&apos;t exist or may have been moved.</p>

        <div className="flex flex-wrap items-center justify-center gap-3 mt-2">
          <Button onClick={handleBack} size="lg" className="group cursor-pointer gap-2" aria-label="Go back to previous page">
