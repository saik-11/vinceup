              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <>
                      <Field data-invalid={fieldState.invalid}>
                        <FieldLabel htmlFor="mentor-password">
                          Password
                        </FieldLabel>
                        <div className="relative">
                  ...
                  render={({ field, fieldState }) => {
                    ...
                    return (
                      <Field data-invalid={showError}>
                        <FieldLabel htmlFor="mentor-confirm">
                          Confirm Password
                        </FieldLabel>
                        <div className="relative">
                          <LockKeyhole className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
          ...
          <FieldSet>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="mentor-state">
                      Province/State
                    </FieldLabel>
                    <Input
                      {...field}
            ...
            <FieldGroup>
              ...
              <div className="grid grid-cols-2 gap-3">
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <FieldLabel htmlFor="mentor-company">
                        Company Name
                      </FieldLabel>
                      <div className="relative">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Controller
                  ...
                  render={({ field, fieldState }) => (
                    <Field data-invalid={fieldState.invalid}>
                      <FieldLabel htmlFor="mentor-industry">
                        Industry
                      </FieldLabel>
                      <div className="relative">
              ...
              <Controller
                ...
                render={({ field, fieldState }) => (
                  <Field data-invalid={fieldState.invalid}>
                    <FieldLabel htmlFor="mentor-experience">
                      Work Experience
                    </FieldLabel>
                    <Select
                      name={field.name}
