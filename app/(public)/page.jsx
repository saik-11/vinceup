...
const testimonials = [
  {
    ...
    rating: 5,
    quote:
      "Within 3 sessions my mentor completely reframed how I approach product sense interviews. Got the Razorpay offer 6 weeks later. Couldn't have done it without VinceUp.",
  },
  {
    name: "Arjun Mehta",
    ...
    rating: 5,
    quote:
      "The IC-to-manager transition felt impossible to navigate alone. My mentor gave me a real playbook and held me accountable every step of the way.",
  },
  {
    name: "Sneha Iyer",
    ...
    rating: 5,
    quote:
      "My mentor had done exactly what I was trying to do — raise a seed round in India. No theoretical advice, only real operator playbooks.",
  },
];
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              ...
              >
                <Button
                  size="lg"
                  className="cursor-pointer gap-2 bg-purple-600 hover:bg-purple-700 text-white border-0 shadow-lg shadow-purple-600/40"
                  asChild
                >
                  <Link href="/mentor">
                    Explore Mentors
            ...
            >
              <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm p-5 space-y-4">
                ...
                <div className="flex items-center gap-3 rounded-xl bg-white/10 p-3">
                  <div className="h-10 w-10 rounded-full bg-linear-to-br from-purple-400 to-indigo-600 flex items-center justify-center text-white font-semibold text-sm shrink-0">
                    RK
                  </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {whyChoose.map((item) => (
              <div
                key={item.title}
                className="group rounded-2xl border bg-white p-6 text-center hover:shadow-md hover:-translate-y-1 transition-all duration-300"
              >
        ...
        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            ...
            <div>
              ...
              <Button
                className="mt-8 cursor-pointer bg-purple-600 hover:bg-purple-700 border-0 shadow-lg shadow-purple-600/30 gap-2"
                asChild
              >
                <Link href="/signup">
                  Try it free
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {featuredMentors.map((m) => (
              <div
                key={m.name}
                className="group rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/10 transition-all duration-300 hover:-translate-y-1"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div
                    className={cn(
                      "h-12 w-12 rounded-xl bg-linear-to-br flex items-center justify-center text-white font-bold text-sm shrink-0",
                      m.bg,
                    )}
                  >
                    {m.initials}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <Button
                className="mt-8 cursor-pointer bg-purple-600 hover:bg-purple-700 border-0 gap-2 shadow-lg shadow-purple-600/25"
                asChild
              >
      ...
      <section className="bg-gray-50 py-20">
        <div className="mx-auto max-w-3xl px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 rounded-2xl border bg-white shadow-sm p-8">
            ...
            <Button
              className="mt-8 cursor-pointer bg-purple-600 hover:bg-purple-700 border-0 gap-2 shadow-lg shadow-purple-600/25 w-full max-w-xs"
              asChild
            >
              <Link href="/mentor">
                Browse Mentors
