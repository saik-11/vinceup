...
function mergeDashboardPayload(overrides = {}) {
  return {
    ...
    recentInsights: overrides.recentInsights ?? baseDashboardPayload.recentInsights,
...
export function getDashboardScenarioName(searchParams = {}) {
  ...
  if (typeof scenarioParam === "string" && Object.hasOwn(dashboardDummyJson, scenarioParam)) {
...
export function getDashboardPayload(scenarioName) {
  return dashboardPayloadSchema.parse(dashboardDummyJson[scenarioName] ?? dashboardDummyJson.default);
}
