...
export const StatusBadge = ({ status }) => {
  ...
  const style = styles[normalized] ?? "bg-slate-50 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700";
  const icon = icons[normalized] ?? null;
