...
const CountryCodePicker = ({ countries = [], isLoading = false, value, onChange, id }) => {
  ...
  const filtered = countries.filter(
    (country) => country.name.toLowerCase().includes(search.toLowerCase()) || country.dialCode.includes(search) || country.code.toLowerCase().includes(search.toLowerCase()),
  );
      ...
      <PopoverTrigger asChild>
        ...
        >
          {isLoading ? (
            ...
            <>
              <Image src={selected.flag} alt="" width={20} height={16} aria-hidden="true" unoptimized className="h-4 w-5 rounded-sm object-cover" />
          ...
          {isLoading ? (
            ...
            filtered.map((country, index) => {
              ...
              return (
                ...
                >
                  <Image src={country.flag} alt="" width={20} height={16} aria-hidden="true" unoptimized className="h-4 w-5 rounded-sm object-cover" />
