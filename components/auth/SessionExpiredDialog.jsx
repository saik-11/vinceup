      ...
      >
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {isWarning ? "Your session is about to expire in less than 2 minutes. Do you want to continue your session or log out?" : "Your session has expired. Please sign in again."}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
